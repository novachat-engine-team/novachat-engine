...
GOGOPROTO_PATH=$ROOT_DIR:$ROOT_DIR/github.com/gogo/protobuf/:$ROOT_DIR/github.com/gogo/protobuf/protobuf/:$ROOT_DIR/service/data/fs:$SRC_DIR
...
Mdocument.proto=novachat_engine/service/data/fs:$PB_DST_DIR \
    $SRC_DIR/*.proto

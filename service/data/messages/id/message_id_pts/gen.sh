...
protoc -I=$SRC_DIR --proto_path=$GOGOPROTO_PATH:./ \
    --gogo_out=plugins=grpc,Mgoogle/protobuf/wrappers.proto=github.com/gogo/protobuf/types,Mgoogle/protobuf/any.proto=github.com/gogo/protobuf/types,Mschema.tl.core_types.proto=novachat_engine/mtproto,Mschema.tl.sync_service.proto=novachat_engine/mtproto,Mschema.tl.sync.proto=novachat_engine/mtproto,Mschema.tl.sync.tl.proto=novachat_engine/mtproto,Mschema.tl.sync.proto=novachat_engine/mtproto,Mschema.tl.transport.proto=novachat_engine/mtproto,Mschema.data.proto=novachat_engine/mtproto:$PB_DST_DIR \
    $SRC_DIR/*.proto

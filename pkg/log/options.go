...
// 配置日志初始化选项
func ConfigOptions(rotate_output_path, log_level string, rotation_max_size, rotation_max_age, rotation_max_backups int) (options *Options) {

	options = &Options{
		RotationMaxSize:    rotation_max_size,
		RotationMaxAge:     rotation_max_age,
		RotationMaxBackups: rotation_max_backups,
		outputLevels:       DefaultScopeName + ":" + log_level,
		stackTraceLevels:   DefaultScopeName + ":" + levelToString[defaultStackTraceLevel],
		RotateOutputPath:   rotate_output_path,
		OutputPaths:        []string{defaultOutputPath},
		ErrorOutputPaths:   []string{defaultErrorOutputPath},
		LogGrpc:            true,
	}

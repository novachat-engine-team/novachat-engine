...
import (
	...
	"novachat_engine/pkg/cmd/msg/server"
	"novachat_engine/pkg/cmd/msg/server/handler"
...
func (m *Application) RunLoop() error {
	...
	msgService.RegisterMsgServiceServer(m.rpcServer, server.NewMsgServiceImpl(handler.NewMsgHandler(&m.conf)))
